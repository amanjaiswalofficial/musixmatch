...
var Artist = function Artist(_ref) {
  ...
  if (!artist) return null; //pull values out from artist

  var images = artist.images,
      name = artist.name,
      followers = artist.followers,
      genres = artist.genres; //apply styles on any element, here on image, note 2 times {{}}
...
function (_Component) {
  ...
  function Tracks() {
    ...
    _defineProperty(_assertThisInitialized(_this), "playAudio", function (previewUrl) {//NOT WORKING, PLAY 30 SECOND SAMPLE OF TRACK ON CLICKING IT
      //AND PAUSE ON CLICKING IT AGAIN
...
var SPOTIFY_API = 'https://spotify-api-wrapper.appspot.com';
...
function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function (artistQuery) {
      fetch("".concat(SPOTIFY_API, "/artist/").concat(artistQuery)).then(function (response) {
        ...
        fetch("".concat(SPOTIFY_API, "/artist/").concat(artist.id, "/top-tracks")).then(function (response) {
          return response.json();
        }).then(function (json) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h2", null, "MusixMatch"), _react.default.createElement("br", null), _react.default.createElement(_Search.default, {
